...
import com.kcsl.lsap.atlas.efg.EventFlowGraphTransformation;
import com.kcsl.lsap.verifier.internal.CFGDisconnectedException;
import com.kcsl.lsap.verifier.internal.EFGCreationException;
import com.kcsl.lsap.verifier.internal.Utils;
import com.kcsl.lsap.verifier.internal.Verifier;
...
public class LSAP {
	...
	public static String verify(Q selected){
		...
		Q predecessors = dataFlowEdges.predecessors(methodParameter(calls, 0));
